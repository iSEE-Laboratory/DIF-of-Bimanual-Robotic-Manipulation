...
class RobotRunner(BaseRunner):
    ...
    def get_action(self, policy: BasePolicy, observaton=None) -> bool:
        ...
        with torch.no_grad():
            ...
            obs_dict_input['left_point_cloud'] = obs_dict['left_point_cloud'].unsqueeze(0)
            obs_dict_input['right_point_cloud'] = obs_dict['right_point_cloud'].unsqueeze(0)
